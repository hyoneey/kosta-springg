 ...
 * Generated at: 2018-05-17 06:32:47 UTC
...
return;
    ...
    try {
      ...
      out.write("<!--  각 파일을 템플릿으로 사용하기위해 handlebars 사용 -->\r\n");
      ...
      out.write("\t\t\t\t\t<h3 class=\"box-title\">REGISTER BOARD</h3>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name='title' class=\"form-control\" placeholder=\"Enter Title\">\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"exampleInputPassword1\">Content</label>\r\n");
      out.write("\t\t\t\t\t\t\t<textarea class=\"form-control\" name=\"content\" rows=\"3\" placeholder=\"Enter ...\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"exampleInputEmail1\">Writer</label> \r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"writer\" class=\"form-control\" placeholder=\"Enter Writer\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<ul class=\"mailbox-attachments clearfix uploadedList\"></ul> <!-- 업로드된 파일이 보여지는 곳 -->\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t<a href=\"{{fullName}}\"  class=\"btn btn-default btn-xs pull-right delbtn\">\r\n");
      out.write("\t\t\t<i class=\"fa fa-fw fa-remove\"></i>\r\n");
      out.write("\t\t</a>\r\n");
      out.write("\t\t</span>\r\n");
      out.write(" \t </div>\r\n");
      out.write("\t</li>                \r\n");
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("\t/* file의 Drag&Drop 표현하는 함수 */\r\n");
      ...
      out.write("\t\t\t\tvar fileInfo = getFileInfo(data); //템플릿에 필요한 객체를 생성\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\r\n");
      out.write("\t/* 업로드 된 파일의 이름을 form태그의 내부에 포함시켜 전송하는 방식 */\r\n");
      out.write("\t$(\"#registerForm\").submit(\r\n");
      out.write("\t\t\tfunction(event) {\r\n");
      out.write("\t\t\t\tevent.preventDefault(); //기본동작 막기\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar that = $(this);\r\n");
      out.write("\t\t\t\tvar str = \"\";\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$(\".uploadedList .delbtn\").each(\r\n");
      out.write("\t\t\t\t\t\t/* hidden으로 두고 배열로 추가 */\r\n");
      out.write("\t\t\t\t\t\tfunction(index) {\r\n");
      out.write("\t\t\t\t\t\t\tstr += \"<input type='hidden' name='files[\" + index\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+ \"]' value='\" + $(this).attr(\"href\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\t+ \"'> \";\r\n");
      out.write("\t\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tthat.append(str);\r\n");
      out.write("\t\t\t\tthat.get(0).submit(); //get(0)은 순수한 dom객체를 얻어내기 위해서 사용\r\n");
      out.write("\t\t\t});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("\r\n");
